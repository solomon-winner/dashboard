            ...
            <div className="w-9/12 ">
                <div className="flex border bg-white rounded-lg shadow-lg mx-auto max-w-sm lg:max-w-4xl">
                    <div
                        ...
                        style={{ backgroundImage: 'url(https://th.bing.com/th/id/R.5c3ffac7de035b684f83c4175f1d710c?rik=hFdoVu5j7RVdaA&pid=ImgRaw&r=0)' }}
                    ></div>
                    <div className="w-full p-8 lg:w-1/2">
                        <h2 className="text-2xl font-bold text-gray-700 text-center">Tree Based Restoration Registry</h2>
                        ...
                        >
                            <Form>
                                ...
                                <div className="mt-8">
                                    <button type="submit" className="bg-mainColor text-white font-bold py-2 px-4 w-full text-center rounded hover:bg-darkMain">
                                        Login
                                    </button>
                                </div>
                            </Form>

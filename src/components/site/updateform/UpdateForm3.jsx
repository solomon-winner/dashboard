          ...
          <div>
            ...
            <div class="flex flex-wrap lg:w-2/3">
              ...
              <RadioButtonGroup
                ...
                options={["Yes", "No"]}
                handleChange={(value) => handleRadioChange("livestockproduction", value)}
              />
              <RadioButtonGroup
              ...
              <RadioButtonGroup
                ...
                options={["Yes", "No"]}
                handleChange={(value) => handleRadioChange("livestockandcropproduction", value)}
              />
              <RadioButtonGroup
                ...
                options={["Yes", "No"]}
                handleChange={(value) => handleRadioChange("nonfarmactivities", value)}
              />
              <RadioButtonGroup
                name="forestseeding"

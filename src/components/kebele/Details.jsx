...
export const Details = () => {
  ...
  if (kebeleData || kebeleData.kebele_data || kebeleData.livelihoods || kebeleData.resources) {
            ...
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
              <div className="p-8 text-gray-600 sm:p-10 lg:flex-auto">
                ...
                <div className="flex text-gray-600 flex-col gap-2">
                  ...
                  {data.data.resources && data.data.resources[3]?.LAND?.map((item, index) => (
                ...
                >
                  {data.data.resources && data.data.resources[4]?.TREE?.filter(
                ...
                <div className="flex text-gray-600 flex-col gap-2">
                  ...
                  {data.data.resources && data.data.resources[2]?.LIVESTOCK?.map((item, index) => (
                    <p key={index} className="font-semibold text-sm">
                      {item.value}:{" "}
                      <span className="font-normal text-xs">{item.amount}</span>
                    </p>
           ...
           <h1 className='text-xl font-bold tracking-tight text-customDark my-1'>Forage grown</h1>
             ...
             <p className='font-semibold'>Truelucern: <span className='font-normal'>1.6</span></p>
                ...
                <div className="flex text-gray-600 flex-col gap-2">
                  ...
                  {data.data.resources && data.data.resources[0]?.CROP?.map((item, index) => (
                    <p key={index} className="font-semibold text-sm">
                      {item.value}:{" "}
                      <span className="font-normal text-xs">{item.amount}</span>
                    </p>
                ...
                <div className="flex text-gray-600 flex-col gap-2">
                  ...
                  {data.data.resources && data.data.resources[1]?.FRUIT?.map((item, index) => (
                    <p key={index} className="font-semibold text-sm">
                      {item.value}:{" "}
                      <span className="font-normal text-xs">{item.amount}</span>
                    </p>
                ...
                <div className="flex text-gray-600 flex-col gap-2">
                  ...
                  {data.data.resources && data.data.resources[5]?.NURSERY?.map((item, index) => (
                    <p key={index} className="font-semibold text-sm">
                      {item.value}:{" "}
                      <span className="font-normal text-xs">

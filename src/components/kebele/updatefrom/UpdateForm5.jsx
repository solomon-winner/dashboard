  ...
  return (
    <div>
      <div>
        ...
        placeholder={["Select Crop Type", "Area"]}
        ...
        onValueChange={(id, name, value) => {
          ...
          const keyToUpdate = name === "croptype" ? `croptype${id}` : `${name}${id}`;
        ...
        <FieldComponent
        initialValues={formData}
        placeholder={["Select Fruit Type", "Area"]}
        type={["dropdown", "number"]}
        ...
        onValueChange={(id, name, value) => {
          ...
          const keyToUpdate = name === "fruittype" ? `fruittype${id}` : `${name}${id}`;
        ...
        <FieldComponent
        initialValues={formData}
        placeholder={["Select Indegeneous Type"]}
        type={["dropdown"]}
        ...
        <FieldComponent
        initialValues={formData}
        placeholder={["Select Exotic Type"]}
        type={["dropdown"]}
        label={["exotictype"]}
        options={
          isLoadingTree

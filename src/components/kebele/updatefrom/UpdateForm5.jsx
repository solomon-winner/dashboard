...
export const UpdateForm5 = ({ handleChange, formData, setFormData }) => {
  ...
  useEffect(() => {
    if (Object.keys(formData).length > 0) {
      ...
      const initialAdditionalFields4 = extractAdditionalFieldsData(
        "exotictype",
        formData
      );
      ...
      const indegeneousType = initialAdditionalFields3.map(
        (item) => item.indegeneoustype
      );
      ...
      // Handle exotictype
      const exoticType = initialAdditionalFields4.map(
        (item) => item.exotictype
      );
          ...
          {additionalFields.map((field, index) => (
            <React.Fragment key={field.id}>
              <FormField
                ...
                value={
                  formData[`cropname${index + 1}`] ||
                  formData[`croptype${index + 1}`]
                }
                onChange={(option) => {
                  handleChanges({
                    target: {
          ...
          {additionalFields2.map((field, index) => (
            <React.Fragment key={field.id}>
              <FormField
                ...
                handleChange={handleChanges}
                value={
                  formData[`fruitname${index + 1}`] ||
                  formData[`fruittype${index + 1}`]
                }
                onChange={(option) => {
                  handleChanges({
                    target: {
          ...
          {additionalFields3.map((field, index) => (
            <React.Fragment key={field.id}>
              <FormField
                ...
                value={
                  formData[`indegeneousname${index + 1}`] ||
                  formData[`indegeneoustype${index + 1}`]
                }
                handleChange={handleChanges}
                onChange={(option) => {
                  handleChanges({
          ...
          {additionalFields4.map((field, index) => (
            <React.Fragment key={field.id}>
              <FormField
                ...
                handleChange={handleChanges}
                value={
                  formData[`exoticname${index + 1}`] ||
                  formData[`exotictype${index + 1}`]
                }
                onChange={(option) => {
                  handleChanges({
                    target: {

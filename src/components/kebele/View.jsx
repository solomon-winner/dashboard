  ...
  return (
    ...
    <form action="#" method="GET" className="hidden lg:block">
              ...
              <div className="mt-1 relative lg:w-64">
                ...
                <input type="text" name="email" id="topbar-search" className="bg-gray-50 border border-mainColor text-gray-900 sm:text-sm rounded-lg outline-none focus:ring-mainColor focus:border-mainColor block w-full pl-10 p-2.5" placeholder="Search"  value={searchInput}
              onChange={handleSearchInput}/>
              </div>
            </form>
    </div>
    <div>
    <Link to="/admin/add-kebele" className='bg-mainColor py-2 px-6 rounded text-white font-semibold hover:bg-customDark'>Add Kebele</Link>
      <Link to="/admin/new-kebele" className='bg-mainColor py-2 px-6 rounded text-white font-semibold hover:bg-customDark'>Add Kebele Data</Link>
    </div>
    </div>
